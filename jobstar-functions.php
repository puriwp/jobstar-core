<?php
/**
 * List of static and callable function for Jobstar Theme.
 *
 * @since      1.0.0
 * @package    Jobstar_Core
 * @author     Puri Themes <services@purithemes.com>
 */

/**
 * Get list of array Font Awesome for select option.
 */
function jobstar_core_fontawesome_option() {
  return apply_filters( 'jobstar_get_fontawesome_sets', array(
    '' => 'Select icon...',
		'fa-500px' => '500px',
		'fa-adjust' => 'Adjust',
		'fa-adn' => 'Adn',
...
/**
 * Get list of array Pe Icon 7 Stroke for select option.
 */
 ...
 * @return 	string
 */
if ( ! function_exists( 'jobstar_get_class_name' ) ) :
function jobstar_get_class_name( $file, $prefix = '', $suffix = '' ) {
...
/**
 * Escape & Validate HTML Color HEX/RGBA Value.
 *
 * @since 	1.0.0
 * @return 	string
 */
if ( ! function_exists( 'jobstar_esc_color' ) ) :
function jobstar_esc_color( $color ) {
...
/*function test_jobstar_fnc() {
  $screen = get_current_screen();
  var_dump( $screen );
}
add_action( 'admin_notices', 'test_jobstar_fnc' );*/